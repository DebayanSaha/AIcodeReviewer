        ...
        <main className='relative  flex p-4 gap-6 '>
          ...
          <section className='relative w-1/2 h-[85vh] bg-black rounded-2xl overflow-hidden flex flex-col'>
              ...
              <button onClick={reviewCode} className='absolute bottom-4 right-4 bg-blue-500 hover:bg-blue-600 
                      ...
                      shadow-lg transition active:scale-95 cursor-pointer'>Review<i className="ml-2 ri-send-ins-fill"></i></button>
          </section>
          {/* right */}
          <section className='h-[85vh]  w-1/2 bg-[#343434] rounded-2xl overflow-auto'>

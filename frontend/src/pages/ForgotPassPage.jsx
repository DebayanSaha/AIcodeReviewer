...
const ForgotPassPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        `https://aicodereviewer-liq8.onrender.com/user/forget-password`,
        { email }
      );
  ...
  return (
    ...
    >
      <div className="min-h-screen flex items-center justify-center bg-linear-to-tl from-stone-900 to-green-950 px-4 md:px-0">
        <div className="w-full max-w-sm md:max-w-none md:w-105 bg-white p-5 md:p-6 rounded-2xl">

          {/* Heading */}
          <div className="flex items-center mb-4 justify-center">
            <h2 className="text-lg md:text-xl font-[font2] font-semibold text-gray-800">
              🔐 Forgot Password
            </h2>
          </div>

          {/* Message */}
          <p className="text-[14px] md:text-[16px] text-gray-600 leading-relaxed mt-2 text-center">
